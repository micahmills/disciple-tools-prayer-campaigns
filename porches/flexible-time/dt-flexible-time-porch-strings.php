 ...
 */
class DT_Flexible_Time_Porch_Strings {
...
//                'translations' => [],
//                'tab' => 'translations',
//                'section' => DT_Flexible_Time_Porch_Translation_Sections::HERO,
//            ],
            'subtitle' => [
                'label' => 'Subtitle',
            ...
            'vision_title' => [
                ...
                'translations' => [],
                'tab' => 'translations',
                'section' => DT_Flexible_Time_Porch_Translation_Sections::VISION,
            ],
            'vision' => [
                'label' => 'Vision',
            ...
            'pray_section_icon' => [
                ...
                'default' => DT_Flexible_Time_Porch::assets_dir() . 'img/pray.svg',
                'value' => '',
                'type' => 'icon',
                'tab' => 'translations',
                'section' => DT_Flexible_Time_Porch_Translation_Sections::THREE,
            ],
            'pray_section_title' => [
            ...
            'movement_section_icon' => [
                ...
                'default' => DT_Flexible_Time_Porch::assets_dir() . 'img/movement.svg',
                'value' => '',
                'type' => 'icon',
                'tab' => 'translations',
                'section' => DT_Flexible_Time_Porch_Translation_Sections::THREE,
            ...
            'time_section_icon' => [
                ...
                'default' => DT_Flexible_Time_Porch::assets_dir() . 'img/24_7.svg',
                'value' => '',
                'type' => 'icon',
                'tab' => 'translations',
                'section' => DT_Flexible_Time_Porch_Translation_Sections::THREE,
            ...
            'what_content' => [
                ...
                'translations' => [],
                'tab' => 'translations',
                'section' => DT_Flexible_Time_Porch_Translation_Sections::WHAT,
            ],
            'prayer_fuel_name' => [
                ...
                'translations' => [],
                'tab' => 'translations',
                'section' => DT_Flexible_Time_Porch_Translation_Sections::FUEL,
            ],
            'prayer_fuel_title' => [
 ...
 */
class DT_Flexible_Time_Porch_Translation_Sections {
    const HERO = 'Hero';
    const VISION = 'Vision';
