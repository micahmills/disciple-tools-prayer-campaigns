...
//        $this->i18n();
    ...
    /**
     * Return the directory that the flexible-time porch assets can be found in
     */
    ...
    public function __call( $method = '', $args = array() ) {
        _doing_it_wrong( 'dt-flexible-time-porch::' . esc_html( $method ), 'Method does not exist.', '0.1' );
        unset( $method, $args );
        return null;
    }
}
