...
class DT_Flexible_Time_Porch_404 extends DT_Magic_Url_Base {
    ...
    public function dt_magic_url_base_allowed_js( $allowed_js ) {
        return DT_Flexible_Time_Porch_Landing_Enqueue::load_allowed_scripts();
    }

    public function dt_magic_url_base_allowed_css( $allowed_css ) {
        return DT_Flexible_Time_Porch_Landing_Enqueue::load_allowed_styles();
    }

    public function wp_enqueue_scripts() {
        DT_Flexible_Time_Porch_Landing_Enqueue::load_scripts();
    }
    ...
    public function body() {
        DT_Flexible_Time_Porch::instance()->require_once( 'top-section.php' );
...
new DT_Flexible_Time_Porch_404();
